...
1. Зарегистрируйся: https://neon.tech
...
6. Вернись в Render → обнови `CORS_ORIGIN` и `WEB_URL` на реальный URL Vercel, например:  
...
1. https://www.brevo.com → регистрация
